...
import { Form, Input, DatePicker, Select, Button, message, Space, InputNumber, Switch, Row, Col, Divider, Tabs } from 'antd';
  ...
  const tabItems = [
    {
      ...
      label: (
        <span>
          <FileTextOutlined /> Dados Básicos
        </span>
      ),
      children: (
        <>
